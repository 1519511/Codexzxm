...
import { PRIVATE_WORKBENCH_TOOL_NAMES, PUBLIC_TOOL_NAMES } from "../src/surface-contracts.mjs";
...
async function listNames(privateEnabled) {
  const privateWorkbench = privateEnabled ? createPrivateWorkbench({ authorityExecutor, browserReader: {}, publicContext: {}, defaultCwd: process.cwd(), workspaceStateDir: ".workbench/surface-v5-state" }) : null;
...
console.log(`Surface unit contract passed: public=${publicNames.length}, private=${privateNames.length}`);
