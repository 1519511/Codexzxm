...
if (!supportedPlatform) {
  process.stderr.write(`Codexzxm currently supports Windows and Apple Silicon macOS only. Current: ${process.platform}/${process.arch}\n`);
  process.exit(1);
}

const nodeMajor = Number.parseInt(process.versions.node.split(".")[0], 10);
if (!Number.isInteger(nodeMajor) || nodeMajor < 22) {
  process.stderr.write(`Codexzxm requires Node.js 22+. Current: ${process.version}\n`);
  process.exit(1);
}
