...
| `node-pty` | `1.1.0` | MIT; shipped LICENSE contains the node-pty historical MIT notices, and bundled `deps/winpty` carries its own MIT LICENSE | Microsoft node-pty |
...
Codexzxm does not claim ownership of third-party names, trademarks, or code. Each dependency remains subject to its own license terms and notices.
