...
Codexzxm 0.7.1-preview.0 exposes the same **124-tool** private V6.1 contract on Apple Silicon macOS. The Mac is a separate execution host and must use its own Secure MCP Tunnel alias/name.
